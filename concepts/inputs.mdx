---
title: "Rokid Inputs: Touchpad, Camera, and Microphone"
sidebarTitle: "Inputs"
...
<CardGroup cols={2}>
  <Card title="Touchpad" icon="hand-pointer">
  ...
  <Card title="Microphone (PCM)" icon="microphone">
  ...
  <Card title="Microphone (WebRTC)" icon="signal-stream">
