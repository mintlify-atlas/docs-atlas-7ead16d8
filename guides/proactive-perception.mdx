---
title: "Proactive Perception Pattern for Glasses Apps"
sidebarTitle: "Proactive Apps"
description: "Build continuous-observation glasses apps that react to what the wearer sees without requiring explicit commands, using stabilization rules and backend workflow authority."
---
...
<CardGroup cols={2}>
  <Card title="VLM Inference" icon="eye">
  ...
  <Card title="Object Detection" icon="crosshairs">
    Fine-tuned or open-vocabulary detector running on the backend. Returns class labels, bounding boxes, and confidence scores. See the [Object Detection guide](/guides/object-detection).
  </Card>
  <Card title="OCR / Markers" icon="font">
    Optical character recognition, barcode, or fiducial marker detection for text and code reading.
  </Card>
  <Card title="Audio Events" icon="microphone">
    Keyword detection, sound classification, or backend audio analysis triggered by the microphone stream.
  </Card>
  <Card title="Periodic Image Turns" icon="camera">
    Scheduled image turns sent to a realtime model for description or classification, without a full live stream.
  </Card>
  <Card title="Hand / Pose / Gesture" icon="hand">
