---
title: "GlassKit Agent Skill for AI Coding Agents"
sidebarTitle: "Agent Skill"
description: "Install the GlassKit skill so Codex, Claude Code, Cursor, or any Agent Skills–compatible agent understands Rokid Glasses constraints and patterns from the first prompt."
---
...
<CardGroup cols={3}>
  ...
  <Card title="references/" icon="file-code">
  ...
  <Card title="assets/rokid-hello-world/" icon="rocket">
